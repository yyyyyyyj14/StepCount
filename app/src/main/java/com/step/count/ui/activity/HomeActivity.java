...
import com.step.count.MyApplication;
...
import com.step.count.commmon.utils.Utils;
...
import com.step.count.ui.adapter.SportCalendarAdapter;
import com.step.count.ui.weight.calendarview.custom.CustomWeekBar;
        ...
        try {
            ...
            if (null != records) {
                ...
                for (SportMotionRecord record : records) {
                    ...
                    pathRecord.setStepCount(record.getmStepCount());
