...
import com.step.count.commmon.utils.CountTimerUtil;
import com.step.count.commmon.utils.DateUtils;
import com.step.count.commmon.utils.LogUtils;
import com.step.count.commmon.utils.MySp;
import com.step.count.commmon.utils.UIHelper;
import com.step.count.db.DataManager;
import com.step.count.db.RealmHelper;
import com.step.count.sport_motion.MotionUtils;
import com.step.count.sport_motion.PathSmoothTool;
import com.step.count.step.StepSensorAcceleration;
import com.step.count.step.StepSensorBase;
 ...
 * 描述: 运动界面
 */
public class SportMapActivity extends BaseActivity implements StepSensorBase.StepCallBack {
...
//                apperaAnim2.start_bg();
    ...
    private void saveRecord() {
        ...
        try {
            ...
            sportMotionRecord.setmStepCount(mStepLen);
